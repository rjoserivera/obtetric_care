    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_ficha', models.CharField(help_text='Se genera automáticamente', max_length=20, unique=True, verbose_name='Número de Ficha')),
                ('nombre_acompanante', models.CharField(blank=True, max_length=200, verbose_name='Nombre del Acompañante')),
                ('numero_gestas', models.IntegerField(default=0, help_text='Total de embarazos incluyendo el actual', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Número de Gestas')),
                ('numero_partos', models.IntegerField(default=0, help_text='Total de partos anteriores', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Número de Partos')),
                ('partos_vaginales', models.IntegerField(default=0, help_text='Número de partos vaginales previos', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Partos Vaginales')),
                ('partos_cesareas', models.IntegerField(default=0, help_text='Número de cesáreas previas', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Partos por Cesárea')),
                ('numero_abortos', models.IntegerField(default=0, help_text='Abortos espontáneos o inducidos previos', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Número de Abortos')),
                ('nacidos_vivos', models.IntegerField(default=0, help_text='Número de hijos nacidos vivos', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Nacidos Vivos')),
                ('fecha_ultima_regla', models.DateField(blank=True, help_text='Primer día de la última menstruación', null=True, verbose_name='Fecha de Última Regla (FUR)')),
                ('fecha_probable_parto', models.DateField(blank=True, help_text='Calculada a partir de FUR o ecografía', null=True, verbose_name='Fecha Probable de Parto (FPP)')),
                ('edad_gestacional_semanas', models.IntegerField(blank=True, help_text='Semanas completas de gestación', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(42)], verbose_name='Edad Gestacional (Semanas)')),
                ...
                ('sgb_resultado', models.CharField(blank=True, choices=[('PENDIENTE', 'Pendiente'), ('POSITIVO', 'Positivo'), ('NEGATIVO', 'Negativo'), ('NO_REALIZADO', 'No Realizado')], default='PENDIENTE', help_text='Resultado de la pesquisa', max_length=20, verbose_name='Resultado SGB')),
                ('sgb_antibiotico', models.CharField(blank=True, help_text='Antibiótico indicado si SGB positivo', max_length=100, verbose_name='Antibiótico para SGB')),
                ('vdrl_resultado', models.CharField(blank=True, choices=[('PENDIENTE', 'Pendiente'), ('NO_REACTIVO', 'No Reactivo'), ('REACTIVO', 'Reactivo'), ('NO_REALIZADO', 'No Realizado')], default='PENDIENTE', help_text='Resultado del tamizaje de sífilis', max_length=20, verbose_name='Resultado VDRL')),
                ('vdrl_tratamiento_atb', models.BooleanField(default=False, help_text='¿Recibió tratamiento antibiótico por VDRL reactivo?', verbose_name='Tratamiento Antibiótico VDRL')),
                ('hepatitis_b_tomado', models.BooleanField(default=False, help_text='¿Se tomó examen de Hepatitis B?', verbose_name='Examen Hepatitis B Realizado')),
                ('hepatitis_b_resultado', models.CharField(blank=True, choices=[('PENDIENTE', 'Pendiente'), ('NEGATIVO', 'Negativo'), ('POSITIVO', 'Positivo'), ('NO_REALIZADO', 'No Realizado')], default='PENDIENTE', help_text='Resultado del examen', max_length=20, verbose_name='Resultado Hepatitis B')),
                ('hepatitis_b_derivacion', models.BooleanField(default=False, help_text='¿Requiere derivación por Hepatitis B positiva?', verbose_name='Derivación a Gastro-Hepatólogo')),
                ('observaciones', models.TextField(blank=True, help_text='Observaciones sobre el embarazo actual', verbose_name='Observaciones Generales')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('motivo_ingreso', models.TextField(help_text='Descripción del motivo de ingreso', verbose_name='Motivo de Ingreso')),
                ...
                ('edad_gestacional_semanas', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(42)], verbose_name='Edad Gestacional (semanas)')),
