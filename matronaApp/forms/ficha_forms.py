...
class FichaObstetricaForm(forms.ModelForm):
    ...
    Incluye nuevos campos de tamizaje
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'sgb_resultado',
            'sgb_antibiotico',
            # 🆕 NUEVOS: Tamizaje VDRL
            'vdrl_resultado',
            'vdrl_tratamiento_atb',
            # 🆕 NUEVOS: Tamizaje Hepatitis B
            'hepatitis_b_tomado',
        ...
        labels = {
            ...
            # 🆕 Nuevos labels
            'patologias_criticas': 'Patologías Críticas',
            'vih_tomado': '¿Toma de VIH Realizada?',
            'vih_resultado': 'Resultado VIH',
            'vih_aro': 'Nº ARO',
            'sgb_pesquisa': '¿Pesquisa SGB Realizada?',
            'sgb_resultado': 'Resultado SGB',
            'sgb_antibiotico': 'Antibiótico por SGB',
            'vdrl_resultado': 'Resultado VDRL',
            'vdrl_tratamiento_atb': 'Tratamiento ATB por Sífilis',
            'hepatitis_b_tomado': '¿Examen Hepatitis B Tomado?',
            'hepatitis_b_resultado': 'Resultado Hepatitis B',
            'hepatitis_b_derivacion': 'Derivación a Gastro-Hepatólogo',
        ...
        help_texts = {
            ...
            'sgb_antibiotico': 'NO por Rotura Prematura de Membranas',
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['vih_aro'].required = False
